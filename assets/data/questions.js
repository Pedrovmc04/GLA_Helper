// Arquivo gerado automaticamente a partir de Resposta_Foxy_Quizz (wiki.gla.com.br).
// Banco de afirmacoes do minigame Verdade ou Mentira.
const QUESTIONS = {
  verdadeiro: [
    "[GLA] A habilidade Liberation, do Marshall D. Teach, tem dois segundos de tempo de recarga e 18 de poder.",
    "[GLA] A habilidade Preparation aumenta a velocidade do Luffy por 4 segundos e concede bônus de força no próximo ataque.",
    "[GLA] Baratie e recomendado para jogadores do level 42 a 52 no minimapa do jogo.",
    "[GLA] A habilidade Usopp Fear concede velocidade e defesa para ele.",
    "[GLA] A rotação semanal muda toda sexta-feira.",
    "[GLA] Baratie é o primeiro local em que você pode construir um navio nível 3.",
    "[GLA] Bartholomew Kuma lê sua bíblia durante a animação do seu emote.",
    ...
    "[GLA] Cocoyasi Village é recomendado para jogadores do level 50 a 60 no minimapa do jogo.",
    "[GLA] É obrigatório derrotar o Jango na missão do Black Cat no modo história.",
    ...
    "[GLA] É possivel criar Medalhas Dinâmicas de Ouro por 20 Moedas Piratas no Mercado Negro.",
    "[GLA] É possivel criar Medalhas Dinâmicas de Prata por 10 Moedas Piratas no Mercado Negro.",
    "[GLA] É possível fazer missões diárias de Tritão em Cocoyasi Village",
    "[GLA] É possível preparar algumas comidas na casa da Nojiko.",
    "[GLA] É possível reparar os equipamentos do seu navio nas Docas.",
    "[GLA] Em Cocoyasi Village, você pode comprar Laranja no NPC por 42 berries cada.",
    ...
    "[GLA] Há 8 Henchman no Mercado Negro.",
    ...
    "[GLA] Jose, discípulo de Carmen, está na biblioteca em Loguetown.",
    "[GLA] Jutte Blow, a habilidade do Smoker, silencia somente usuários de Fruta do Diabo.",
    "[GLA] Kumo Island é recomendada para jogadores do level 64 a 72 no minimapa do jogo.",
    "[GLA] Kuro causa 20% a mais de dano quando ataca inimigos pelas costas.",
    ...
    "[GLA] Ninjin, um dos Piratas do Usopp, dá uma missão em Syrup Village.",
    ...
    "[GLA] O nome de todas as habilidades do Capone Gang Bege começam com a letra C, exceto o Big Father.",
    "[GLA] O PvP na Grand Line será opcional",
    "[GLA] O Sangramento do Alligator selvagem também reduz a velocidade de movimento do personagem.",
    "[GLA] O Stash VIP tem 100 espaços para itens.",
    ...
    "[GLA] Orange Town é recomendada para jogadores do level 23 a 30 no minimapa do jogo.",
    "[GLA] Para melhorar um personagem de 1 para 5 estrelas você precisa usar 840 medalhas no total.",
    "[GLA] Pearl é o primeiro boss na missão da Armada Pirata.",
    ...
    "[GLA] Quando um Alligator selvagem morre, o sangramento aplicado por ele perde o efeito.",
    ...
    "[GLA] Sayuri, Asuya e Chieri são nomes de NPCs do Baratie.",
    "[GLA] Skins de navio estão disponiveis somente para navios de nivel dois ou maior.",
    ...
    "[GLA] Urouge pode usar a Habilidade Pray para curar aliados e também remover condições de lentidão ou queimadura.",
    "[GLA] Você não pode trocar seus equipamentos em batalha.",
    "[GLA] Você pode comprar duas abas extras do Stash. A primeira custa 15 gemas e a segunda 30 gemas.",
    "[GLA] Você pode construir uma Caixa de Música no Mercado Negro.",
    ...
    "[GLA] Você precisa vencer com um time de especialistas para completar a conquista dos Black Cat.",
    "[GLA] Você precisa vencer com um time de lutadores para completar a conquista dos Piratas do Buggy.",
    "[GLA] Você precisa vencer com um time de chapéus de palha para completar a conquista dos Piratas do Arlong.",
    "[GLA] Você precisa vencer com um time de usuários de Fruta do Diabo para completar a conquista da Base da Marinha.",
    "[GLA] Você precisa vencer com uma equipe de mulheres para completar a conquista da Armada Pirata.",
    "[GLA] Whale Shark é considerado um monstro nível 3.",
    ...
    "A comida favorita de Kuro é banana.",
    "A comida favorita do Doflamingo é lagosta.",
    "A comida favorita do Marco é abacaxi.",
    "A comida favorita do Nezumi é queijo.",
    "A cor do cabelo da mãe da Nico Robin é branco.",
    "A dubladora do Chopper foi alterada em alguns episódios.",
    "A espada de Shiliew é uma Meito chamada \"Raiu\".",
    "A espada do Shiryu é uma Meito chamada \"Raiu\".",
    ...
    "A Ope Ope no Mi é também chamada da Fruta do Diabo Suprema, devido a sua habilidade de conceder vida eterna.",
    "A personagem Boa Hancock possui várias referências a mitologia Grega.",
    "A primeira recompensa da Nico Robin foi de 79,000,000 de berry, a mesma quantia de sua mãe Nico Olvia.",
    "A primeira recompensa do Monkey D. Luffy foi de 30,000,000 de berry.",
    "A primeira recompensa do Tony Tony Chopper foi de 50 berry.",
    "A quarta recompensa do Monkey D. Luffy foi de 400,000,000 de berry.",
    "A recompensa da Curly Dadan é de 7,800,000 de berry.",
    "A recompensa da Miss Doublefinger é de 35.000.000 berries.",
    "A recompensa da Miss Goldenweek é de 29,000,000 de berry.",
    "A recompensa da Miss Merry Christmas é de 14,000,000 de berry.",
    "A recompensa da Miss Valentine é de 7,500,000 de berry.",
    "A recompensa de Daz Bones é de 75,000,000 de berry.",
    "A recompensa do Lao G era de 61,000,000 de berry antes de ser congelado em razãp do Doflamingo ter se tomado um Shichibukai.",
    ...
    "A recompensa do Mont Blanc Cricket é de 25,000,000 de berry.",
    ...
    "A recompensa do Mr. 5 é de 10,000,000 de berry.",
    "A recompensa do Pica era de 99,000,000 de berry antes de ser con gelada em razão do Doflamingo ter se tornado um Shichibukai.",
    "A recompensa do Senor Pink era de 58,000,000 de berry antes de ser congelada em razão do Doflamingo ter se tornado um Shichibukai.",
    ...
    "A recompensa do X-Drake é de 222,000,000 de berry.",
    ...
    "A segunda recompensa de Monkey D. Luffy foi de 100.000.000 de berries.",
    "A Yubashiri (Espada de Zoro) Enferrujou.",
    "A Yubashiri (uma das espadas do Zoro) enferrujou.",
    ...
    "A recompensa de Kuroobi é de 9,000,000 de berry.",
    "A recompensa do Bartholomew Kuma é de 296,000,000 de berry.",
    "A recompensa do Capone Gang Bege é de 300.000.000 berries.",
    "A recompensa do Chew é de 5,500,000 de berry.",
    "A recompensa do Dellinger era de 15,000,000 de berry antes de congelada em razão do Doflamingo ter se tornado Shichibukai.",
    ...
    "A recompensa do Gladius era de 31,000,000 de berry antes de ser congelada em razão do Doflamingo ter se tornado um Shichibukai.",
    ...
    "Antes dos eventos da guerra, Jesus Burguess tinha uma recompensa de 20,000,000 de berry.",
    ...
    "Aokiji tem uma Fruta do Diabo do tipo Logia.",
    ...
    "Arlong é o único indivíduo conhecido que foi liberado de Impel Down.",
    ...
    "Assim como Fujitora, Smoker deseja acabar com o sistema de Shichibukai.",
    ...
    "Barba Negra é um Almirante dos Piratas do Barba Negra e membro dos Yonkou.",
    "Barba Negra nasceu na Grand Line.",
    "Bartholomew Kuma é conhecido como o Tirano.",
    "Bartholomew Kuma e um Shichibukai e um ex-oficial do Exercito Revolucionario.",
    "Bartholomew Kuma já foi um Rei.",
    "Basil Hawkins é um pirata infâme do North Blue conhecido como o Mago e capitão dos Piratas do Hawkins.",
    "Bellamy se aposentou oficialmente como um pirata e agora se dedica a pintura de bandeiras.",
    ...
    "Brook é mais alto que o Franky depois do Timeskip.",
    "Brook era o capitão dos Rumbar Pirates.",
    ...
    "Buggy tem a menor recompensa conhecida entre os Shichibukai.",
    ...
    "Catarina Devon caça qualquer MULHER que ela acha atraente e decapita a cabeça para adicionalas a sua coleção pessoal.",
    ...
    "Crocodile é o unico Shichibukai a possuir uma fruta tipo Logia.",
    ...
    "Demaro Black nasceu no East Blue.",
    "Demaro Black, capitão dos Falsos Chapéu de Palha, nasceu no East Blue.",
    ...
    "Doflamingo era Capitão dos Piratas Donquixote.",
    ...
    "Foxy nasceu no South Blue.",
    "Franky é o oitavo membro a entrar no Bando dos Chapéus de Palha.",
    ...
    "Giolla criou Dellinger praticamente sozinha, fazendo com que ele pensasse que era uma menina, razão pela qual ele se tornou tão afeminado.",
    "Gol D. Roger foi o primeiro Rei dos Piratas.",
    "Gol D. Roger nasceu em Loguetwon.",
    ...
    "Hancock é a imperatriz do Amazon Lily, motivo pelo qual ela é chamada de Imperatriz Pirata.",
    ...
    "Joy Boy foi mencionado no Ryugu Poneglyph lido por Nico Robin enquanto ela estava na Floresta do Mar.",
    ...
    "Kenbushoku no Haki garante ao usuário o sexto sentido do mundo ao seu redor e habilidades precognitivas limitadas.",
    ...
    "Kinemon comeu a Fuku Fuku no Mi.",
    "Kin'emon comeu a Fuku Fuku no Mi.",
    "Kinemon é usuário de Haki da Observação e do Armamento.",
    "Kinemon pode se comunicar através de peidos, fazendo eles soarem como a linguagem humana.",
    "Kizaru comeu a Pika Pika no Mi.",
    "Koala é uma Humana que pode usar o Karate Tritão.",
    "Koala é uma Oficial do Exército Revolucionário.",
    "Koala era um membro dos Piratas do Sol.",
    "Koala está lutando no Exército Revolucionário para mudar o mundo de uma forma que os Trtões e as Sereias sejam tratados como pessoas normais.",
    "Kuma é conhecido como Tirano.",
    "Kureha nasceu em Drum Island.",
    "Kuro, também conhecido pelo seu apelido Klahadore, é o capitão dos Piratas Black Cat.",
    ...
    "Lucky Roo pode parecer gordo e lento, mas na verdade ele é um lutador muito ágil e rapido.",
    "Luffy realmente nasceu em Foosha.",
    ...
    "O aniversário da Miss Valentine é no Valentines Day, por razões óbvias.",
    "O cabelo do Trebol é preto.",
    "O Canhão do Mr. 4 comeu uma Fruta do Diabo e tornou-se um cachorro.",
    "O dragão contra qual Luffy e os outros lutaram em Punk Hazard foi criado artificialmente por Vegapunk em um labortório em Punk Hazard.",
    "O navio que a Hancock e as piratas Kuja navegam é chamado de Perfume Snake.",
    "O nome da espada do Shanks é Gryphon.",
    "O nome do navio do Mr. 2 era Swanda Express.",
    "O nome do Navio que Mr. 5 e Miss Valentine usavam em suas operações era Pop Rock Candy.",
    "O nome do navio que o Mr. 1 e a Miss Doublefinger usavam em suas operaçòes era Kill Sasssoon.",
    "O nome do navio que os Piratas Donquixote usaram nos dias deles no North Blue era Numancia Flamingo.",
    "O nome dos navios do Masira e do Shoujo é Victory Hunter e Utan Sonar, respectivamente.",
    ...
    "O nome verdadeiro do Mr. 4 é Babe, provavelmente em referência ao famoso jogador de basebol Babe Ruth.",
    "O nome verdadeiro do Mr. 5 é Gem.",
    "O primeiro beijo conhecido de Sanji foi com a Pudding.",
    ...
    "O sonho de Crocodile era se tornar o Rei dos Piratas.",
    "O verdadeiro nome da Miss Doublefinger é Zala.",
    "O verdadeiro nome da Miss Valentine é Mikita.",
    "O verdadeiro nome do Mr. 1 é Daz Bones.",
    "O verdadeiro nome do Mr. 2 é Bon Clay Bentham.",
    "O verdadeiro nome do Mr. 3 é Galdinho.",
    "Oars é um gigante.",
    "Objetos podem comer Frutas do Diablo.",
    "Os Unluckies nasceram na Grand Line.",
    "Os Yeti Cool Brothers são parte de uma subespécie desconhecida de gigantes.",
    "Otohime era conhecida pela alcunha \"Encarnação do Amor\" devido a sua incrível bondade e busca pela paz entre diferentes espécies.",
    "Otohime tinha um Haki da Observação muito desenvolvido, o que a permitia entender profundamente a emoção dos outros.",
    "Pagaya é pai da Conis.",
    "Pappag é uma estrela do mar que é mascote da Camie e também professor. Ele é o criador de uma linha de moda",
    ...
    "Por causa de seus crimes Sanjuan Wolf foi aprisionado em uma grande cela no nível 6 de Impel Down.",
    "Portgas D. Ace é filho da Rouge.",
    "Portgas D. Ace é filho do Gold Roger.",
    "Portgas D. Ace era o comandante da segunda divisão dos Piratas do Barba Branca.",
    "Portgas D. Ace era o segundo comandante da divisão dos Piratas do Barba Branca.",
    "Portgas D. Ace era um usuário de Haki do Rei.",
    "Portgas D. Ace nasceu em Baterilla.",
    ...
    "Scratchmen Apoo é um infâme pirata com tema de música, membro da tribo Braço-Longo e capitão dos Piratas On Air.",
    ...
    "Shanks é um membro dos Yonkou que governa o Novo Mundo e capitão dos Piratas do Ruivo.",
    "Shanks nasceu no West Blue.",
    "Shanks tem uma cicatriz no olho esquerdo.",
    "Shiliew é o capitão da segunda frota do Teach.",
    "Shiryu é o capitão da segunda frota do Teach.",
    "Shiryu nasceu na Grand Line.",
    "Silvers Rayleigh tem uma esposa no Arquipélago Sabaody.",
    "Smoker comeu a Moku Moku no Mi.",
    ...
    "Tamago perdeu o olho esquerdo para Pedro.",
    ...
    "Trafalgar Law comeu a Ope Ope no Mi.",
    ...
    "Trafalgar Law perdeu um braço no Arco de Dressrosa.",
    "Tralfagar Law é conhecido por ser o Cirurgião da Morte.",
    "Trebol é usuário do Haki da Observação e do Armamento.",
    ...
    "Usopp foi o terceiro membro a entrar na tripluação dos Chapéu de Palha.",
    "Van Augur nasceu no East Blue.",
    "Van Augur, o Supersônico, é um Sniper dos Piratas do Barba Negra e um excelente atirador.",
    "Vasco Shot é o capitão da oitavo navio, liderando a oitava frota do Teach.",
    ...
    "Zeus é um personagem de One Pece.",
    "Zoro empunhou mais de 8 espadas diferentes no anime.",
    "[GLA] Você só pode trocar seus equipamentos em uma Zona Segura.",
    "[GLA] Em Conomi Island você pode encontrar os seguintes inimigos: Moles, Wolves e Baby Moles."
  ],
  falso: [
    ...
    "[GLA] A habilidade de nível 100 do Arlong, Shark on Tank, imobiliza o inimigo.",
    ...
    "[GLA] Alvida, Don Krieg, Gin e Pearl são os únicos boss de missão especial que não aparecem nos spawns das ilhas.",
    "[GLA] Alvida Pirates é a única Missão Especial do modo história sem uma versão no modo Difícil.",
    "[GLA] Anel da cruz é um item recomendado para o nível 50.",
    ...
    "[GLA] Atum e a melhor comida que você pode comprar de um NPC em termos de cura por segundo para um personagem level 70.",
    "[GLA] Backflips e habilidades de evasão concedem imunidade a dano e imobilizações.",
    "[GLA] Baratie e recomendado para jogadores do level 42 a 50 no minimapa do jogo.",
    ...
    "[GLA] Carne de Porco Gourmet é a comida mais demorada para cozinhar do Baratie. Demora 8 minutos.",
    ...
    "[GLA] É possível criar Medalhas Dinâmicas de Ouro por 15 Moedas Piratas no Mercado Negro.",
    "[GLA] É possível criar Medalhas Dinâmicas de Prata por 8 Moedas Piratas no Mercado Negro.",
    "[GLA] É possível criar Poção Média de EXP, Poção Grande de EXP e Poção Pequena de EXP no Mercado Negro.",
    "[GLA] É possível criar Poção Pequena de EXP no Mercado Negro.",
    "[GLA] É preciso completar com um time de especialistas para ganhar a conquista do Arlong.",
    ...
    "[GLA] Enquanto está em chamas, Pearl tem as seguintes habilidades - Fire Pearl Shot, Fire Presente, Fire Pearl Close e Fire Pearl Daítokuten.",
    "[GLA] Erros no jogo devem ser reportados no servidor do Discord.",
    "[GLA] Espada Dadao é um item recomendado para o nível 10.",
    ...
    "[GLA] Genzo vende Bandana de Tritão, Calça de Tritão, Anel do Mar e Turbante do Mar por 5000 berry cada.",
    "[GLA] Há uma Prisioneira chamada Tita no Arlong Park.",
    "[GLA] Helmeppo está localizado no mesmo prédio que seu pai Morgan.",
    "[GLA] Henry Needle, Henry Blazer, Henry Stripe e Henry Ford são nomes de algumas habilidades do Niji.",
    ...
    "[GLA] Kumo Island é recomendado para jogadores do level 64 a 70 no minimapa do game.",
    ...
    "[GLA] Leo, discípulo de Carmen, está na biblioteca de Loguetown.",
    "[GLA] Loguetown é recomendada para jogadores do level 56 a 70 no minimapa do jogo.",
    ...
    "[GLA] Monkey D. Luffy têm as seguintes classes: Bruiser, Lutador e Tanque.",
    ...
    "[GLA] Nami pode criar somente 3 nuvens simultaneamente.",
    "[GLA] Não é possivel entrar na mansão da Kaya.",
    ...
    "[GLA] NPC Sora em Samui Island é uma menina.",
    "[GLA] O Barba Negra tem as seguintes classes: Especialista, Bruiser e Atirador. A ultima é porque ele tem um revólver.",
    ...
    "[GLA] O Kit de Reparo 2.0 restaura 22.000 pontos de vida do seu navio em 20 segundos.",
    "[GLA] O Kit de Reparo 2.0 restaura 700 pontos de vida do seu navio por segundo.",
    "[GLA] O Kit de Reparo 3.0 restaura 30.000 pontos de vida do seu navio em 20 segundos.",
    ...
    "[GLA] O NPC Magra pede por 4 Orelhas e Lobo na missão dele em Foosha Village.",
    "[GLA] O sangramento do Killer pode acumular até 4 vezes usando mais Bloody Cuts ou Kira Nokogiri.",
    ...
    "[GLA] O Pearl é o primeiro inimigo em Pirata Armada.",
    "[GLA] Picareta de Mineração é um item para cortantes e tanques.",
    "[GLA] Piiman, um dos piratas do Usopp, dá algumas missões em Syrup Village.",
    "[GLA] Pufferfish e Sharks são considerados monstros nível 3.",
    "[GLA] Quando Bonney usa sua habilidade Unbridled Power, ela transforma todos a sua em bebês e fica invulnerável por 9 segundos.",
    "[GLA] Quando Sanji cura uma mulher, ele fica motivado e recebe bônus de velocidade e ataque por 10 segundos.",
    "[GLA] Sabo é o nome da criança que a Nojiko pede para ajudar no Arlong Park.",
    "[GLA] Sanji pode se curar com a habildade Master Cook.",
    "[GLA] Sanzen Sekai é a habilidade mais forte do jogo em termos de poder.",
    "[GLA] Sapi é o NPC que vende Atum em Cocoyasi Village.",
    "[GLA] Sayuri, Asuya e Cherry são nomes de NPCs do Baratie.",
    "[GLA] Shanks imobiliza inimigos em volta dele com a habilidade Busoshoku Haki Waves.",
    "[GLA] Shanks mata inimigos fracos instantaneamente com a habilidade Kenbushoku Haki.",
    ...
    "[GLA] Todos os chapéu de Palha possuem uma Skin do Strong World.",
    "[GLA] Trafalgar Law não pode quebrar paredes com a habilidade Injection Shot.",
    "[GLA] Trafalgar Law não pode usar nenhuma habilidade quando está fora da Room.",
    "[GLA] Um personagem Diamante precisa de mais medalhas para ter suas estrelas melhoradas do que um personagem Ouro.",
    "[GLA] Você pode comprar duas abas extras do Stash. A primeira custa 15 gemas e a segunda 20 gemas.",
    "[GLA] Você não pode trocar sua página de equipamentos em uma Zona Segura.",
    "[GLA] Você pode começar uma missão diária de derrotar Slimes na Samui Island.",
    "[GLA] Você pode conseguir o item Colar do Saru em qualquer Missão Difícil do East Blue.",
    "[GLA] Você pode construir uma Caixa de Música por 200 moedas piratas no Mercado Negro.",
    ...
    "[GLA] Você pode usar a mesa de construção nas docas para transforma 5 Poções Médias de Experiência em 1 Poção Grande de Experiência.",
    ...
    "[GLA] Você pode usar a mesa de construção nas docas para transformar 10 Poções Pequenas de Experiência em 2 Poção Média de Experiência.",
    ...
    "A alcunha do Laffitte, shinigami ou deus da morte, vem do fato dele gosta de brincar com a vida das pessoas, assim como um shinigami.",
    "A atual recompensa da Boa Hancock é 79,000,000 de berry.",
    "A atual recompensa de Marshall D. Teach é de 2.247.600 de berries.",
    ...
    "A espada de Shilliew é uma Meito chamada \"Rain\".",
    "A mãe do Usopp nasceu no South Blue.",
    "A maior recompensa conhecida é de 1,500,000,000 de berry.",
    "A maior recompensa conhecida é de 2,257,600,000.",
    "A primeira recompensa da Nico Robin foi de 78,000,000 de berry, a meesma quantia de sua mãe Nico Olvia.",
    "A recompensa da Baby Five é de 17,000,000 de berry.",
    "A recompensa da Baby Five é de 23,000,000 de berry.",
    "A recompensa da Boa Hancock é de 79.000.000 de berries.",
    "A recompensa da Jewelry Bonney é de 140,000,000 de berry.",
    "A recompensa da Miss Valentine é de 7,000,000 de berry.",
    "A recompensa da Olivia era de 79,000,000 de berry, o mesmo que sua filha Nami recebeu depois...",
    "A recompensa do Lao G era de 60,000,000 de bery antes de ser congelada em razão do Doflamingo ter se tornado um Shichibukai.",
    ...
    "A recompensa do Mr. 5 é de 9,000,00 de berry.",
    "A recompensa do Mr.3 é de 23,000,000 de berry.",
    "A recompensa do Pica era de 100,000,000 de berry antes de ser con gelada em razão do Doflamingo ter se tornado um Shichibukai.",
    ...
    "Akira Toriyama é o criador de One Piece.",
    "Alvida é a antiga capitã dos Piratas do Buggy.",
    "A recompensa de Hathan é de 7.000.000.",
    ...
    "A recompensa do Daz Bones é de 70,000,000 de berry.",
    "A recompensa do Dellinger era de 12,000,000 de berry antes de ser congelada em razão do Doflamingo ter se tornado um Shichibukai.",
    ...
    "A recompensa do Hatchan é de 7,000,000 de berry.",
    "A recompensa do Jinbe é de 439,000,000 de berry.",
    "A recompensa do Jinbe era de 200,000,000 de berry antes dele se tomar um Shichibukai.",
    "A recompensa do Kuro é de 6,000,000 de berry.",
    "A recompensa do Kuroobi é de 8,000,000 de berry.",
    "Antes dos eventos da guerra, Doc Q tinha uma impressionanterecompensa de 72,500,000 de berry.",
    ...
    "Após ser diagnosticado com sua doença, Gol D. Roger levou dois anos para encontrar o One Piece.",
    "Arlong era capitão dos Piratas do Sol e tinha a maior recompensa do East Blue antes de ser derrotado pelo Monkey D. Luffy.",
    "Arlong já foi um escravo.",
    ...
    "Barba Branca foi o responsável por cicatrizar o olho e Shanks com sua arma de garras.",
    ...
    "Bepo não é um Mink.",
    "Boa Hancock é a capitã das Piratas Kuja e a segunda mulher membro dos Shichibukai.",
    "Boa Hancock nasceu no North Blue.",
    "Boa Hancock tem a mesma dubladora da Reiju.",
    "Boa Marigold e Boa Sandersonia tem somente Haki do armamento.",
    "Boodle é o prefeito de Syrup Village.",
    ...
    "Cada um dos principais membros da tripulação do Shanks são do mesmo oceano.",
    ...
    "Catarina Devon caça qualquer homem que ela acha atraente e decapita a cabeça deles para adicioná-las na sua coleção pessoal.",
    "Catarina Devon é a capitã do quinto navio, liderando a quinta frota do Teach.",
    "Catarina Devon nasceu na Grand Line.",
    "Charlotte Linlin é uma das filhas da Big Mom.",
    "Charlotte Shujan é um dos filhos da Big Mom.",
    "Chess nasceu no West Blue.",
    "Chopper é um Guaxinim que comeu a Fruta Human-Human.",
    "Como um dos principais membrs do Exército Revolucionário, Koala tem uma recompensa de 320,000,000 de berry.",
    ...
    "Damaro Black, Manjaro, Chocolat, Drip, Turco, Cocoa, MountMOUNTAIN e Nora Gitsune são os nomes verdadeiros da falsa tripulação dos Chapéus de Palha.",
    "Demaro Black, capitão dos Falsos Chapéu de Palha, nasceu no West Blue.",
    "Dentre a Tripulação dos Chapéu de Palha, Luffy é o membro favorito de Eiichiro Oda.",
    "Depois do Timeskip o Franky é o mais alto dos Piratas do Chapéu de Pala.",
    "Diamante foi o primeiro a encontrar Ito Ito no Mi quando era um criminoso.",
    ...
    "Doflamingo foi o primeiro personagem a desperta sua Fruta do Diabo.",
    "Doflamingo matou Gecko Moria.",
    "Donquixote Doflamingo é o capitão dos Piratas Donquixote.",
    ...
    "Duval é irmão do Sanji.",
    "Em termos simples, Haki é a habilidade de sentir energia espiritual (Busoshoku), usar força vital (Haoshoku) e dominar inimigos (Kenbunshoku).",
    ...
    "Erik e um personagem non-canon de One Piece.",
    "Eustass Kid perdeu seu braço direito.",
    "Existem três tipos de Haki disponíveis para todo mundo.",
    ...
    "Franky destruiu o projeto da Uranus.",
    "Franky é um robô.",
    "Franky era o antigo líder da Família Franky e atual Capitão dos Piratas Ciborgues.",
    ...
    "Franky foi o sétimo membro a entrar na tripulação dos Chapéu de Palha.",
    "Frost é um personagem do One Piece.",
    "Funkfreed é o nome do Elefante do Spandam.",
    "Genzo nasceu no North Blue.",
    "Genzo também é um Médico.",
    "Gin é capitão dos Piratas do Gin.",
    "Gin tem o mesmo dublador do Kuro.",
    "Gin tem uma recompensa de 10,000,000.",
    ...
    "Haoshoku no Haki concede ao usuario um sextro sentido do mundo ao seu redor e habilidades precognitivas limitadas.",
    "Haoshoku no Haki garante ao usuário um sexto sentido do mundo ao seu redor e habilidades precognitivas limitadas.",
    "Hatchan é um ex-oficial dos Piratas do Sol e membro dos Piratas do Arlong antes de disso.",
    "Hatchan tem 8 braços.",
    "Hody Jones é o Capitão dos Piratas Homens-Peixe.",
    "Impel Down tem 7 níveis.",
    "Inazuma nasceu no North Blue.",
    "Ishoo nasceu no South Blue.",
    "Issho comeu a Fuji Fuji no Mi, que o permite manipular a gravidade.",
    "Issho nasceu no South Blue.",
    "Jango é um Marinheiro e ex-capitâo dos Piratas Black Cack.",
    "Jesus Burgess é navegador dos Piratas do Barba Negra.",
    ...
    "Kanjuro comeu a Draw Draw no Mi, que o permite trazer a vida tudo o que ele desenha.",
    ...
    "Kinemon comeu a Tuku Tuku no Mi.",
    "Kinemon é usuário de Haki do Armamento apenas.",
    "Kizaru nasceu na Grand Line.",
    "Kuro, também conhecido pelo seu apelido Klahadore, é o capitão dos Piratas Neko.",
    "Kuro, Capitão dos Piratas Black Cat, era também conhecido por seu apelido de Klahadore.",
    "Kuroobi é um oficial dos Piratas do Sol e ex-membros dos Piratas do Arlong.",
    "Kuzan decidiu se cegar porque havia muitas coisas que ele não queria ver.",
    ...
    "Madame Shyarly é uma das irmãs do Arlong.",
    "Magellan comeu a Moku Moku no Mi.",
    "Marco comeu a Pori Pori no Mi, tipo Fênix, uma Zoan Mítica.",
    ...
    "Monet tinha uma Fruta do Diabo do tipo Paramercia.",
    "Monkey D. Garp é o verdadeiro pai de Luffy.",
    "Monkey D. Garp nasceu no South Blue.",
    "Monkey D. Luffy foi a primeira pessoa a escapar de Impel Down.",
    "Monkey D. Luffy foi a única pessoa a escapar de Impel Down na história.",
    "Monkey D. Luffy nasceu em Nanko Village,",
    "Mr. 3 queria trair o Crocodile desde o início do arco.",
    "Mr. 4 nasceu no East Blue.",
    "Mr. 5 nasceu no West Blue.",
    "Nami conseguiu o Clima-Tact em Drum Island.",
    "Nami foi o terceiro membro a entrar na tripulação dos Chapéu de Palha.",
    "Nanashaku Jitte é um item de nível 70 que pode ser usado por todas as classes.",
    "Nefertati Vivi é um membro dos Piratas do Chapéu de Palha.",
    "Nico Robin é referida como Demônio da Revolução pelo Exérito Revolucionário.",
    "O anime One Piece é o maior já feito.",
    "O cabelo do Charlotte Cracker é verde.",
    "O dragão contra qual Luffy e os outros lutaram em Punk Hazard foi criado artificialmente por Caesar em um laboratório em Punk Hazard.",
    ...
    "O nome da espada do Shanks é Python.",
    ...
    "O nome dos navios do Masira e do Shoujo é Utan Sonar e Victory Hunter, respectivamente.",
    "O nome verdadeiro da Baby Five é Babi.",
    "O nome verdadeiro da Miss Goldenweek é Drophy.",
    "O nome verdadeiro da Miss MerryChristmas é Marianne.",
    "O nome verdadeiro do Hatchan é Hatchi.",
    "O nome verdadeiro do Mr. 4 é Derek, provavelmente em referência ao famoso jogador de basebol Derek Jeter.",
    "O nome verdadeiro do Mr. 5 é Rem.",
    "O nome verdadeiro de Trebol é John Trebol.",
    "O primeiro beijo conhecido do Sanji foi com a Violet.",
    "O principal navio do Exército Revolucionário é chamado de Viento GRANMAR.",
    "O projeto da Pluton ainda não foi descoberto.",
    "O verdadeiro nome da Miss Doublefinger é Paula.",
    ...
    "Os Yeti Cool Brothers são parte de uma subespécie de humanos.",
    "Otohime era conhecida pela alcunha \"Reencarnação do amor\" devido a sua incrível bondade e busca pela paz entre diferentes espécies.",
    ...
    "Pagaya é uma estrela do mar que é mascote de Camie e Também professor. Ele é o criador de uma linha de moda.",
    "Pandaman é da tripulação do Law.",
    "Pandaman está na tripulação do Trafalgar Law.",
    "Pappag é um caçador de recompensas que apareceu no Arquipélago Sabaody.",
    ...
    "Portgas D. Ace era o segundo comandante da divisão dos Spades Pirates.",
    "Potgas D. Ace era o comandante da segunda divisão dos Spade Pirates.",
    "Punk Hazard pode ser encontrado com um Log Pose.",
    "Python é o nome da espada do Shanks.",
    "Recompensa do X-Drake é de 220.200.207 berries.",
    ...
    "Sanji foi o quinto membro a entrar na tripulação dos Chapéu de Palha.",
    "Sanji nasceu no South Blue.",
    "Sanjuan Wolf é o capitão do quinto navio, liderando a quinta frota do Teach.",
    "Scratchmen Apoo é da tribo Longarm, um infâme pirata com tema de música e capitâo dos Piratas On Music.",
    "Sendai Kitetsu (uma das espadas do Zoro) enferrujou.",
    "Sengoku comeu a Bito Bito no Mi, uma fruta Zoan Mítica.",
    "Sengoku nasceu no North Blue.",
    "Shanks é membro dos Yonko que governam o novo mundo e é o capitão dos piratas do Shanks.",
    "Shanks é um membro dos Yonko que governa o Novo Mundo e capitão dos Piratas do Shanks.",
    "Shanks foi o primeiro dono do Chapéu de Palha.",
    "Shanks nasceu no East Blue.",
    "Shanks tem uma cicatriz no olho direito.",
    "Shiliew é o capitão da terceira frota do Teach.",
    ...
    "Tamago perdeu o olho direito para Pedro.",
    ...
    "Trafalgar Law é membro dos Piratas do Chapéu de Palha.",
    "Trafalgar Law já foi um escravo.",
    "Trafalgar Law perdeu um braço durante o Timeskip.",
    "Trebol tinha Fruta do Diabo do tipo Logia.",
    "Tsuru comeu a Washe Washe no Mi.",
    "Tsuru nasceu no East Blue.",
    "Urouge é também conhecido como Mad Monk. Ele é um pirata de uma ilha do céu e capitãp dos Piratas Mad Monk.",
    ...
    "Woop Slap é o prefeito de Orange Town.",
    "Zeff perdeu sua perna esquerda para salvar Sanji",
    "Zoro empunhou menos de 8 espadas diferentes no anime",
    "[GLA] Você precisa vencer com um time de cortantes para completar a conquista da Alvida.",
